package com.example.mixed_drems_mobile.presentation.pages.auth.signup
...
import com.example.mixed_drems_mobile.presentation.MainActivity
...
private fun register(
    ...
    if (email.isNotEmpty() && password.isNotEmpty() &&
        ...
        if (password == confirmPassword) {
            scope.launch {
                val authService: IAuthRepository = AuthRepositoryImpl()
